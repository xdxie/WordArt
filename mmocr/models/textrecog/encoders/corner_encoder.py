...
from mmocr.models.textrecog.layers import Adaptive2DPositionalEncoding, CornerCrossattnLayer
from .base_encoder import BaseEncoder


@ENCODERS.register_module()
class CornerEncoder(BaseEncoder):
    ...
    def forward(self, feat, corner_feat, img_metas=None):
        """
        Args:
