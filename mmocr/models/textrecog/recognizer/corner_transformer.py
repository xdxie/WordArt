...
from mmocr.models.textrecog.losses import CCLoss 

@RECOGNIZERS.register_module()
class CornerTransformer(BaseRecognizer):
    """Base class for encode-decode recognizer."""

    def __init__(self,
                 preprocessor=None,
                 backbone=None,
                 backbone_corner=None,
                 encoder=None,
                 decoder=None,
                 loss=None,
        ...
        self.backbone_corner = build_backbone(backbone_corner)
    ...
    def forward_train(self, img, img_metas):
        ...
        if self.encoder is not None:
            out_enc = self.encoder(feat, corner, img_metas)
        ...
        char_cont_loss = self.cc_loss(char_out_dec, targets_dict, img_metas)
        losses.update(char_cont_loss)
